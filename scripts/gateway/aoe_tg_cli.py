...
def build_parser(*, deps: Dict[str, Any]) -> argparse.ArgumentParser:
    ...
    p.add_argument("--verifier-roles", default=os.environ.get("AOE_VERIFIER_ROLES", deps["DEFAULT_VERIFIER_ROLES"]), help="comma-separated verifier role names (default: Reviewer,QA,Verifier)")
