...
## Required Workflow
1. Check inbox: `AOE_TEAM_DIR=<project>/.aoe-team aoe-team inbox --for Local-Analyst --unresolved`
2. Acknowledge quickly: `AOE_TEAM_DIR=<project>/.aoe-team aoe-team ack <id> --for Local-Analyst --note "accepted"`
3. Execute and report progress with `aoe-team reply <id> --body "..."`
4. Mark done with evidence: `AOE_TEAM_DIR=<project>/.aoe-team aoe-team done <id> --for Local-Analyst --note "<evidence>"`
5. If blocked: `AOE_TEAM_DIR=<project>/.aoe-team aoe-team fail <id> --for Local-Analyst --note "<blocker>"`
